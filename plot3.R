...
## Plot 3: Energy sub metering - plot with three functions of time


# Preparing   
# In working directory  
# this file "plot3.R" and the unzipped folder "exdata-data-household_power_consumption" 
...
dt1<-select(dt1,DateTime,Sub_metering_1,Sub_metering_2,Sub_metering_3)
#dt1:  2075259 obs. of 4 var. chr 
