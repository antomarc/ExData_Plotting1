...
## Plot 4: Power voltage energy - multiple plots


# Preparing   
# In working directory  
# this file "plot4.R" and the unzipped folder "exdata-data-household_power_consumption" 
...
dt1<-select(dt1,datetime,Global_active_power,Global_reactive_power,Voltage,Sub_metering_1,Sub_metering_2,Sub_metering_3)
#dt1:  2075259 obs. of 7 var. chr 
...
#dt 2880 obs of 7 var
for(i in 2:7){dt[,i]<-as.numeric(dt[,i])}
...
with(dt,{
  ...
  plot(datetime,Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
    ...
    legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=1,cex=.9,lwd=0,box.col=par("bg"))
